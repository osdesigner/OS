...
async function sendOrderToBackend() {
    ...
    try {
        ...
        const customerData = userDoc.docs[0].data();
        ...
        alert(`تم إرسال الطلب بنجاح! رقم الطلب: ${docRef.id}`);
        ...
        sendBtn.innerHTML = '<i class="fas fa-paper-plane" style="margin-left:8px;"></i>ارسال الطلبات';
